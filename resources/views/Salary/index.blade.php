        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form" method="POST" action="{{route('save_salary_head')}}">
                        @csrf
                        <div class="box-body">
                            @if (session('error'))
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($salaryHead as $s)
                                <tr>
                                    <td>{{$s->name}}</td>
                                    <td class="text-center"><a href="{{route('edit_salary_head',["id" => $s->id ])}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a></td>
                                </tr>
                            @endforeach
                            </tbody>
                            <tfoot>
