                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="text" required="required" value="{{$e->Name}}" class="form-control" name="Name" placeholder="Enter  Name" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Father Name</label>
                                        <input maxlength="100" type="text" required="required" class="form-control" value="{{$e->fatherName}}" name="fatherName" placeholder="Enter Father Name" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Last Name</label>
                                        <input maxlength="100" type="text" required="required" class="form-control" value="{{$e->lastName}}" name="lastName" placeholder="Enter Last Name" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="text" required="required" class="form-control"  value="{{$e->Religion}}" name="Religion" placeholder="Enter Religion" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="email" required="required" class="form-control"  value="{{$e->Email}}" name="Email" placeholder="Enter Email" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="text" required="required" class="form-control"  value="{{$e->City}}" name="City" placeholder="Enter City" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">City</label>
                                        <input maxlength="100" type="text" required="required" class="form-control"  value="{{$e->per_City}}" name="per_City" placeholder="Enter City" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="text" required="required" class="form-control"  value="{{$e->accountNumber}}" name="accountNumber" placeholder="Enter Number" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required="required" class="form-control"  value="{{$e->ISFC}}" name="ISFC" placeholder="Enter ISFC" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="text" required="required" class="form-control"  value="{{$e->adharNumber}}" name="adharNumber" placeholder="Enter Number" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Adhar Proof</label>
                                        <input maxlength="100" type="file"  class="form-control"  value="{{$e->adharProof}}" name="adharProof" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="text" required="required" class="form-control"  value="{{$e->panNumber}}" name="panNumber" placeholder="Enter Number" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Pan Proof</label>
                                        <input maxlength="100" type="file" class="form-control"  value="{{$e->panProof}}" name="panProof" />
                                    </div>
                                </div>
                            </div>
                            <button class="btn btn-primary nextBtn pull-right" type="button">Next</button>
